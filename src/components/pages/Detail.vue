<template>
  <div class="program-detail">
    <div class="detail-main">
      ...
      <div ref="content" v-html="content" class="content"></div>
    </div>
      ...
      <div class="comment-edit">
        ...
        <Poptip placement="left-end">
          <div class="emoij-box" @click="eomijShow">
            <div class="emoij-btn"></div>
            <span>表情</span>
          </div>
          <div slot="content">
            <!-- 评论表情 -->
            <ul class="category">
              <li v-for="(item, ind) in categoryList" :key="ind" @click="chooseEmoij(item)">
...
export default {
  ...
  methods: {
    ...
    chooseEmoij(src) {
      ...
      var imgHtml =
        '<img class="emoji" style="width: 22px;height: 22px;display: inline-block;vertical-align: top;" draggable="false" src="' +
        src +
        '">';
