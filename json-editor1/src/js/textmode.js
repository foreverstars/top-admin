...
textmode.create = function (container, options) {
  ...
  if (this.options.mainMenuBar) {
    ...
    buttonFormat.title = 'JSON数据格式，适当的缩进和换行(Ctrl+\\)'
    ...
    buttonCompact.title = '压缩JSON数据，删除所有空格(Ctrl+Shift+\\)';
    ...
    buttonRepair.title = '修复JSON:修复引号和转义字符，删除注释和JSONP表示法，将JavaScript对象转换为JSON.'
